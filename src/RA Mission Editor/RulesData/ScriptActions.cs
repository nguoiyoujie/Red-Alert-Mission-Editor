  ...
  public static class ScriptActions
		...
		static ScriptActions()
    {
			_listScriptAction = new List<ScriptActionType>()
			{
				...
				new ScriptActionType("07 - Attack Tarcom", "Attack a specific target using its unique identifier", ScriptParameterType.TARGET),
				...
				new ScriptActionType("12 - Set Global", "Set a specified global variable", ScriptParameterType.GLOBALS),

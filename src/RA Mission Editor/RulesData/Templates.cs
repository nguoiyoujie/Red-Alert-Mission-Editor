  ...
  public static class Templates
  {
		...
		static Templates()
    {
			_listTemplate = new List<TemplateType>()
			{
				...
				/* Bridges */
				new TemplateType(LandType.LAND_RIVER, "BRIDGE1") { IsBridge = true },
				new TemplateType(LandType.LAND_RIVER, "BRIDGE1D") { IsBridge = true },
				new TemplateType(LandType.LAND_RIVER, "BRIDGE2") { IsBridge = true },
				new TemplateType(LandType.LAND_RIVER, "BRIDGE2D") { IsBridge = true },
				/* Slopes (Cliffs) */
				...
				/* Big Bridges */
				new TemplateType(LandType.LAND_RIVER, "BR1A") { IsBridge = true },
				new TemplateType(LandType.LAND_RIVER, "BR1B") { IsBridge = true },
				new TemplateType(LandType.LAND_RIVER, "BR1C") { IsBridge = true },
				new TemplateType(LandType.LAND_RIVER, "BR2A") { IsBridge = true },
				new TemplateType(LandType.LAND_RIVER, "BR2B") { IsBridge = true },
				new TemplateType(LandType.LAND_RIVER, "BR2C") { IsBridge = true },
				new TemplateType(LandType.LAND_RIVER, "BR3A") { IsBridge = true },
				new TemplateType(LandType.LAND_RIVER, "BR3B") { IsBridge = true },
				new TemplateType(LandType.LAND_RIVER, "BR3C") { IsBridge = true },
				new TemplateType(LandType.LAND_RIVER, "BR3D") { IsBridge = true },
				new TemplateType(LandType.LAND_RIVER, "BR3E") { IsBridge = true },
				new TemplateType(LandType.LAND_RIVER, "BR3F") { IsBridge = true },
				/* Big Fords */
				...
				/* Non-Interior Pieces */
				/* More Bridges */
				new TemplateType(LandType.LAND_BEACH, "BRIDGE1H") { IsBridge = true },
				new TemplateType(LandType.LAND_BEACH, "BRIDGE2H") { IsBridge = true },

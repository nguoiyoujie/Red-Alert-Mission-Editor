  ...
  public static class TriggerActions
		...
		static TriggerActions()
    {
			...
			_listTriggerAction = new List<TriggerActionType>()
			{
				...
				new TriggerActionType("43 - Add building type to sidebar", "Adds BUILDINGTYPE to the trigger house's sidebar, bypassing prerequisites", p1Type: TriggerParameterFlag.STRUCTURETYPE),
				...
				new TriggerActionType("45 - Add vessel type to sidebar", "Adds VESSELTYPE to the trigger house's sidebar, bypassing prerequisites", p1Type: TriggerParameterFlag.SHIPTYPE),
				...
				new TriggerActionType("62 - Create structure at", "Creates a STRUCTURE for a HOUSE at a WAYPOINT. This mimics the building placement process, so if the terrain is blocked, the structure will not be created", p1Type: TriggerParameterFlag.STRUCTURETYPE, p2Type: TriggerParameterFlag.WAYPOINT, p3Type: TriggerParameterFlag.HOUSE),

  ...
  public static class TriggerEvents
	{
		...
		static TriggerEvents()
		{
			...
			_listTriggerEvent = new List<TriggerEventType>()
			{
				...
				new TriggerEventType("01 - Entered by", "An object belonging to the specified HOUSE enters the attached cell or structure", p2Type: TriggerParameterFlag.HOUSE),
				new TriggerEventType("02 - Spied by", "A unit with Infiltrate=yes belonging to the specified HOUSE enters the attached structure", p2Type: TriggerParameterFlag.HOUSE),
				...
				new TriggerEventType("00 - Destroyed Buildings All", "All structures, excepting insignificant civilian objects, belonging to the specified HOUSE, has been destroyed", p2Type: TriggerParameterFlag.HOUSE),
				...
				new TriggerEventType("16 - Destroyed Units #", "The specified NUMBER of structures, including civilian objects, belonging to the trigger house, has been destroyed", p2Type: TriggerParameterFlag.INTEGER),
				...
				new TriggerEventType("19 - Build Building Type", "The player has placed the STRUCTURE on the map", p2Type: TriggerParameterFlag.STRUCTURETYPE),
				...
				new TriggerEventType("32 - Building exists", "The trigger house owns the specified STRUCTURE on the map", p2Type: TriggerParameterFlag.STRUCTURETYPE),
			};
